...
const services: Service[] = [
    ...
    },
    {
        ...
        description: "Teaching AI integration, efficiency, workflow optimization",
        location: "GLOBAL",
        techTags: ["OpenAI", "LLM Workflows", "Automation Strategy"],
        details: "I help teams understand how to leverage AI tools to amplify productivity, streamline processes, and unlock new capabilities in their work.",
