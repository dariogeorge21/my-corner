    ...
    <div style="font-family:'Segoe UI',Arial,sans-serif;max-width:620px;margin:0 auto;background:#0d0d0d;border-radius:12px;overflow:hidden;border:1px solid #222;">
      ...
      <div style="padding:32px 40px;">
        <table style="width:100%;border-collapse:collapse;">
          ...
          ${data.phone ? `
          <tr>
            <td style="padding:14px 0;border-bottom:1px solid #1e1e1e;color:#888;vertical-align:top;font-size:11px;text-transform:uppercase;letter-spacing:1.5px;font-weight:600;">Phone</td>
            <td style="padding:14px 0;border-bottom:1px solid #1e1e1e;font-size:15px;"><a href="tel:${data.phone}" style="color:#a78bfa;text-decoration:none;font-weight:500;">${data.phone}</a></td>
          </tr>` : ""}
          <tr>
...
/**
 * Server action — handles form submission directly.
 */
export async function submitContact(formData: ContactFormData): Promise<ContactResponse> {
  ...
  try {
    ...
    console.log(`[submitContact] Email sent — from: ${email}, subject: "${subject}"`)
